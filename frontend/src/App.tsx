...
function getDocsArticle(articleId: DocsArticleId): DocsArticle {
  ...
  const articles: Record<Exclude<DocsArticleId, "package" | "repository" | "dependencies" | "preflight">, DocsArticle> = {
    ...
    wallet: {
      ...
      intro: "This guide covers mainnet buyer integration with Circle CLI. Production facilitator selection is controlled at runtime by CIRCLE_FACILITATOR_URL; the Arc mainnet target is https://gateway-api.circle.com. Arc Mainnet configuration: prepared / pending live acceptance. Arc Testnet paid lifecycle: verified historically on the tested path only, not evidence of mainnet acceptance.",
      sections: [
