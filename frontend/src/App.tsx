...
function getDocsArticle(articleId: DocsArticleId): DocsArticle {
  ...
  const articles: Record<Exclude<DocsArticleId, "package" | "repository" | "dependencies" | "preflight">, DocsArticle> = {
    ...
    wallet: {
      ...
      intro: "This guide covers mainnet buyer integration with Circle CLI. Mainnet-ready seller configuration targets https://gateway-api.circle.com after a separate deployment/environment switch. Arc Mainnet configuration: prepared / pending live acceptance. Arc Testnet paid lifecycle: verified historically on the tested path only, not evidence of mainnet acceptance.",
      sections: [
